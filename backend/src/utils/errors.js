...
const Errors = {
  ...
  JOB_NOT_COMPLETED:       ()    => new AppError(400, 'JOB_NOT_COMPLETED', 'Job must be completed first.'),
  ...
  ALREADY_RATED:           ()    => new AppError(409, 'ALREADY_RATED', 'You have already rated this job.'),
  ...
  JOB_NOT_REJECTABLE:      ()    => new AppError(422, 'JOB_NOT_REJECTABLE', 'Job can only be rejected when status is accepted.'),
